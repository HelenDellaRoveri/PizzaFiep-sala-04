        ...
        <section className="sobre" id="sobre">
            ...
            <div className="conteudo">
                ...
                <div className="texto-lateral">
                    ...
                    <p>Mais do que servir pizzas, queremos criar memórias. Seja em um encontro entre amigos, uma pausa depois de um dia de trabalho ou uma comemoração especial, a Pizza FIEP é um lugar para compartilhar, conversar e aproveitar o melhor da boa comida.
                    </p>
                </div>
            </div>
        </section>
